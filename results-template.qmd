...
# filler accuracy = correct if edit distance less than or equal to 2 (done)
# remove people with filler accuracy less than 90% (done)
# remove people who learned english after the age of 7 (8 and above) (done)
# change classification of critical sentences (done)
