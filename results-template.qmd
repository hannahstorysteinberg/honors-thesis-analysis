...
prob_sim_leg <- logit2prob(summary(model_interaction_sim_leg)$coefficients[1,1])
...
prob_sim_ill <- logit2prob(summary(model_interaction_sim_ill)$coefficients[1,1])
...
prob_dis_leg <- logit2prob(summary(model_interaction_dis_leg)$coefficients[1,1])
...
prob_dis_ill <- logit2prob(summary(model_interaction_dis_ill)$coefficients[1,1])
