...
# sim = 0, leg = 0
model_interaction_sim_leg <- glmer(isNonLiteral ~ 1 + sim_dummy_sim_leg_dummy_leg * sim_dummy_sim
                           + (1 | subj)
                           #+ (0 + sim_dummy_sim | subj)
                           #+ (0 + leg | subj)
                           + (1 | sent),data = final_df,family="binomial")
...
# sim = 0, ill = 0
model_interaction_sim_ill <- glmer(isNonLiteral ~ 1 + leg * sim_dummy_sim
                           + (1 | subj)
                           #+ (0 + sim_dummy_sim | subj)
                           #+ (0 + leg | subj)
                           + (1 | sent),data = final_df,family="binomial")
...
# dis = 0, leg = 0
model_interaction_dis_leg <- glmer(isNonLiteral ~ 1 + leg * sim_dummy_sim
                           + (1 | subj)
                           #+ (0 + sim_dummy_sim | subj)
                           #+ (0 + leg | subj)
                           + (1 | sent),data = final_df,family="binomial")
...
# dis = 0, ill = 0
model_interaction_dis_ill <- glmer(isNonLiteral ~ 1 + leg * sim_dummy_sim
                           + (1 | subj)
                           #+ (0 + sim_dummy_sim | subj)
                           #+ (0 + leg | subj)
                           + (1 | sent),data = final_df,family="binomial")
